...
def main():
    ...
    config_path = './audioclip/protocols/audioclip-us8k-demo.json'
    train_loader_us8k, test_loader_us8k = get_dataloader(config_path)
            ...
            with model.ema_scope():
                ...
                for n in trange(opt.n_iter, desc="Sampling"):
                    for prompts in tqdm(data, desc="data"):
                        uc = None
                        if opt.scale != 1.0:
                            uc = torch.load('null_cond_tensor.pt').to(device)
...
#                         x_checked_image = x_samples_ddim
                        ...
                        if not opt.skip_save:
                            ...
                            for x_sample in x_checked_image_torch:
                                ...
                                img.save(os.path.join(sample_path, f"{base_count:05}-" + sound_name + ".png"))
                                base_count += 1
                                idx += 1
