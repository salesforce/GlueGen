...
## Ours
```
python scripts/img2img.py --prompt "a sign says "Salesforce" on the top" --init-img <path-to-img.jpg> --strength 0.8

python scripts/txt2img.py --prompt "a photograph of an astronaut riding a horse" --plms --config configs/stable-diffusion/v1-inference-trans.yaml
